...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-906-erd-s-problem-906-a8776b81-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-906"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-906-erd-s-problem-906-a8776b81-v1",
      "problem_contract_sha256": "b250ec00ebf687ffa34c5b8bcf2f152a31b5675971c198aaa415a228e22f1cd8",
      "problem_id": "problem:um-ep-906-erd-s-problem-906-a8776b81",
      "route_id": "route:um-ep-906-erd-s-problem-906-a8776b81-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-906-erd-s-problem-906-a8776b81-source-fidelity-01",
      "graph_id": "graph:um-ep-906-erd-s-problem-906-a8776b81-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-906-erd-s-problem-906-a8776b81-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-906-erd-s-problem-906-a8776b81-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is there an entire non-zero function $f:\\mathbb{C}\\to \\mathbb{C}$ such that, for any infinite sequence $n_1<n_2<\\cdots$, the set $ \\{ z: f^{(n_k)}(z)=0 \\textrm{ for some }k\\geq 1\\} $ is everywhere dense?"
          },
          "statement_sha256": "7d08010c2e77f34a969908ad2b14e0d2c3f2ab87e58da967d191acdfaf893197"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-906-erd-s-problem-906-a8776b81-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-906-erd-s-problem-906-a8776b81-root",
      "route_id": "route:um-ep-906-erd-s-problem-906-a8776b81-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-906-8177183010ff",
        "url": "https://www.unsolvedmath.com/problems/EP-906"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
